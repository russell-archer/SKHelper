...
public extension View {
    ...
    ///
    @ViewBuilder func SKHelperButtonStyleBorderless() -> some View {
    ...
    ///
    func SKHelperButtonStyleBorderedProminent(
...
/// macOS button styles.
@MainActor
public struct SKHelperMacOSButtonStyle: ButtonStyle {
